...
public class DocInfoPredstavitelstvaType {
    ...
    protected InfoUchetNalogOraganPodrazdlType свУчетНОПредстав;
     ...
     *     
     */
    public InfoUchetNalogOraganPodrazdlType getСвУчетНОПредстав() {
     ...
     *     
     */
    public void setСвУчетНОПредстав(InfoUchetNalogOraganPodrazdlType value) {
