...
public class DocSvUl {
    ...
    protected DocInfoOKVEDType свОКВЭД;
    @XmlElement(name = "\u0421\u0432\u041b\u0438\u0446\u0435\u043d\u0437\u0438\u044f")
    protected List<DocInfoLicensiaType> свЛицензия;
    @XmlElement(name = "\u0421\u0432\u041f\u043e\u0434\u0440\u0430\u0437\u0434")
    protected DocInfoPodrazdelType свПодразд;
    @XmlElement(name = "\u0421\u0432\u0420\u0435\u043e\u0440\u0433")
    protected List<DocInfoReorganType> свРеорг;
    @XmlElement(name = "\u0421\u0432\u041f\u0440\u0435\u0434\u0448")
    protected List<DocInfoPredshtstvType> свПредш;
    @XmlElement(name = "\u0421\u0432\u041a\u0424\u0425\u041f\u0440\u0435\u0434\u0448")
    protected List<DocInfoKFHPredshestvType> свКФХПредш;
    @XmlElement(name = "\u0421\u0432\u041f\u0440\u0435\u0435\u043c")
    protected List<DocInfoPreemnikType> свПреем;
    @XmlElement(name = "\u0421\u0432\u041a\u0424\u0425\u041f\u0440\u0435\u0435\u043c")
    protected DocInfoKFHPrimnikType свКФХПреем;
    @XmlElement(name = "\u0421\u0432\u0417\u0430\u043f\u0415\u0413\u0420\u042e\u041b", required = true)
    protected List<DocInfoRecordEGRULType> свЗапЕГРЮЛ;
     ...
     *     
     */
    public DocInfoOKVEDType getСвОКВЭД() {
        return свОКВЭД;
    }
     ...
     *     
     */
    public void setСвОКВЭД(DocInfoOKVEDType value) {
        this.свОКВЭД = value;
    }
     ...
     * 
     */
    public List<DocInfoLicensiaType> getСвЛицензия() {
        if (свЛицензия == null) {
            свЛицензия = new ArrayList<DocInfoLicensiaType>();
        }
     ...
     *     
     */
    public DocInfoPodrazdelType getСвПодразд() {
        return свПодразд;
    }
     ...
     *     
     */
    public void setСвПодразд(DocInfoPodrazdelType value) {
     ...
     * 
     */
    public List<DocInfoReorganType> getСвРеорг() {
        if (свРеорг == null) {
            свРеорг = new ArrayList<DocInfoReorganType>();
        }
        return this.свРеорг;
    }
     ...
     * 
     */
    public List<DocInfoPredshtstvType> getСвПредш() {
        if (свПредш == null) {
            свПредш = new ArrayList<DocInfoPredshtstvType>();
        }
        return this.свПредш;
    }
     ...
     * 
     */
    public List<DocInfoKFHPredshestvType> getСвКФХПредш() {
        if (свКФХПредш == null) {
            свКФХПредш = new ArrayList<DocInfoKFHPredshestvType>();
        }
     ...
     * 
     */
    public List<DocInfoPreemnikType> getСвПреем() {
        if (свПреем == null) {
            свПреем = new ArrayList<DocInfoPreemnikType>();
        }
        return this.свПреем;
    }
     ...
     *     
     */
    public DocInfoKFHPrimnikType getСвКФХПреем() {
        return свКФХПреем;
    }
     ...
     *     
     */
    public void setСвКФХПреем(DocInfoKFHPrimnikType value) {
     ...
     * 
     */
    public List<DocInfoRecordEGRULType> getСвЗапЕГРЮЛ() {
        if (свЗапЕГРЮЛ == null) {
            свЗапЕГРЮЛ = new ArrayList<DocInfoRecordEGRULType>();
        }
