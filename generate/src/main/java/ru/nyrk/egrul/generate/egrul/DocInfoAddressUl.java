...
public class DocInfoAddressUl {

    @XmlElement(name = "\u0410\u0434\u0440\u0435\u0441\u0420\u0424", required = true)
    protected AddressRFEGRULType addressRF;
    @XmlElement(name = "\u0421\u0432\u0435\u0434\u041e\u0442\u0441\u0443\u0442\u0410\u0434\u0440\u0435\u0441\u042e\u041b")
    protected List<DocInfoNedostAddressUl> сведОтсутАдресЮЛ;
     ...
     *     
     */
    public AddressRFEGRULType getAddressRF() {
        return addressRF;
    }
     ...
     *     
     */
    public void setAddressRF(AddressRFEGRULType value) {
     ...
     * {@link DocInfoNedostAddressUl }
     * 
     * 
     */
    public List<DocInfoNedostAddressUl> getСведОтсутАдресЮЛ() {
        if (сведОтсутАдресЮЛ == null) {
            сведОтсутАдресЮЛ = new ArrayList<DocInfoNedostAddressUl>();
        }
