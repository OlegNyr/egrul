...
public class DocInfoRegisterULType {

    @XmlElement(name = "\u0421\u043f\u041e\u0431\u0440\u042e\u041b", required = true)
    protected DocInfoObrazovULType спОбрЮЛ;
     ...
     * @return
     *     possible object is
     *     {@link DocInfoObrazovULType }
     *     
     */
    public DocInfoObrazovULType getСпОбрЮЛ() {
        return спОбрЮЛ;
    }
     ...
     *     
     */
    public void setСпОбрЮЛ(DocInfoObrazovULType value) {
        this.спОбрЮЛ = value;
    }
